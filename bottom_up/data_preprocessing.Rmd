...
def get_features(input_csv: str, output_csv: str, batch_size=50):
    ...
    df.to_csv(output_csv, index=False, columns=['sentence','word','pos','tag', 'local'])
...
if __name__ == '__main__':
    ...
    get_features(filtered_csv, preprocessed_csv)
